...
%theta          = Nominal angle
%ASDdeg         = Angular standard deviation around the nominal angle (measured in degrees)
%antennaSpacing = (Optional) Spacing between antennas (in wavelengths)
%distribution   = (Optional) Choose between 'Gaussian', 'Uniform', and 'Laplace' angular distribution. Gaussian is default
%% OUTPUT:
