...
for n = 1:nbrOfSetups    
    ...
    for c = 1:2        
        ...
        for s = 1:length(fRange)            
            ...
            for j = 1:L                
                %Determine the strongest UE in each cell and average over the signal and interference powers in different cells
                ...
                %Determine the weakest UE in each cell and average over the signal and interference powers in different cells
...
%Compute the average signal and interference powers with respect to different setups with random UE locations
