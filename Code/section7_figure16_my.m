%% This Matlab script can be used to reproduce Figures 7.16 in the monograph:
...
for i = 1:size(POS,1)    
    ...
    %Compute correlation matrices for smaller antenna geometries by selecting the corresponding antenna indices
    for m = 1:M_max-1
