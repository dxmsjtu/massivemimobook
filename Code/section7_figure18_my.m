%% This Matlab script can be used to reproduce Figures 7.18 in the monograph:
...
d = d_V;
%Simulate new channel reponses or load existing results (the latter is the preset)
simulate = true; %false
%% Simulate channels
if (simulate)
